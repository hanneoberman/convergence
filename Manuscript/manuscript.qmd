...
[TODO: add *approximate* convergence as the most converged state that the algorithm can obtain?]
...
```{r, cache=TRUE, eval=FALSE, fig.height=9}
performance |>
  filter(method == "MICE") |>
ggplot(aes(x = .it, y = psrf_mean)) +
